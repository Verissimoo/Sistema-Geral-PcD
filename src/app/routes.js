...
export const routes = [
  ...
  { path: "/vendedor/campanhas", roles: COMERCIAL, page: () => import("@/features/campanhas/pages/VendedorCampanhas") },
  { path: "/vendedor/campanhas/:id", roles: COMERCIAL, page: () => import("@/features/campanhas/pages/VendedorCampanhaDetalhe") },
